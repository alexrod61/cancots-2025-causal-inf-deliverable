...
- How <span style="color: purple;">theoretical</span> should we conceive the course? @lubbke2020 provide a fair <span style="color: purple;">simulation-based</span> starting via <span style="color: purple;">generative modelling</span> and <span style="color: purple;">regression analysis</span>
:::
